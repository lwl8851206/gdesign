...
<head>
	...
	<link rel="stylesheet" href="../css/tweetdetail.css" type="text/css">
	<link rel="stylesheet" href="../css/common.css" type="text/css">
	<title>tweetdetail</title>
	<base href="<%= basePath%>">	
</head>
<body>
	<header  id="header">
...
<script src="weibo/js/tweetdetailapp.js"></script>
<script src="weibo/js/tweetdetailcontroller.js"></script>
</body>
</html>